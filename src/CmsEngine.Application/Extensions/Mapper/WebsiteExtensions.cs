...
public static class WebsiteExtensions
{
    extension(Website item)
    {
        ...
        /// <returns></returns>
        public WebsiteEditModel MapToEditModel()
        {
    ...
    extension(WebsiteEditModel item)
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Website MapToModel(Website website)
        {
            website.Id = item.Id;
    ...
    extension(IEnumerable<Website> websites)
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IEnumerable<WebsiteTableViewModel> MapToTableViewModel()
        {
