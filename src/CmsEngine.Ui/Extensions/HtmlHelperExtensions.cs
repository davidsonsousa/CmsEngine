...
public static class HtmlHelperExtensions
{
    ...
    {
        public string IsSelected(string? controllers = null, string? actions = null, string? slugs = null, string cssClass = "active")
        {
        ...
        private bool CheckValues(string valueName, string? values)
        {
