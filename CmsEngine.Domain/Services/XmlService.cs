...
namespace CmsEngine.Domain.Services
{
    public class XmlService : Service, IXmlService
    {
        ...
        public XmlService(IUnitOfWork uow, IHttpContextAccessor hca, ILogger log) : base(uow, hca, log)
        {
            _unitOfWork = uow;
        }
        ...
        public async Task<XDocument> GenerateFeed()
        {
            ...
            foreach (var item in await _unitOfWork.Posts.GetPostsOrderByDescending(o => o.PublishedOn))
            {
        ...
        public async Task<XDocument> GenerateSitemap()
        {
            ...
            var orderedPosts = await _unitOfWork.Posts.GetPostsOrderByDescending(o => o.PublishedOn);
            ...
            var orderedPages = await _unitOfWork.Pages.GetPagesOrderByDescending(o => o.PublishedOn);
