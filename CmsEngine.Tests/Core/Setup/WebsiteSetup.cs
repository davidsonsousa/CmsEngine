...
namespace CmsEngine.Tests.Core.Setup
{
    public static class WebsiteSetup
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static WebsiteEditModel GetEditModel()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static WebsiteViewModel GetViewModel()
        {
        ...
        public static WebsiteService SetupService()
        {
            ...
            return new WebsiteService(moqUnitOfWork.Object, moqMapper.Object);
        }
    }
}
